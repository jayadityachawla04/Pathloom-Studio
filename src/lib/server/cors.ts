...
//
// Allowed origins are controlled by the `PATHLOOM_CORS_ALLOWED_ORIGINS` env
// var:
...
/**
 * Parses `PATHLOOM_CORS_ALLOWED_ORIGINS` into either wildcard access or an explicit allow-list.

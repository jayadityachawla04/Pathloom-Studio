...
This directory contains sample OTLP trace data to help you explore the features of pathloom-studio.
...
Demonstrates how pathloom-studio handles a trace where the root span arrives **after** its children — a common real-world scenario with async exporters or API gateways.
